export const pl = {
  ...
  app: {
    ...
    documents: {
      ...
      newDocument: "Nowy dokument",
      titleFallback: (id: string) => `Dokument ${id}`,
      searchPlaceholder: "Szukaj po tytule, identyfikatorze, głosie lub modelu",
      refresh: "Odśwież",
      refreshing: "Odświeżanie",
      loading: "Ładowanie dokumentów...",
      emptyTitle: "Nie masz jeszcze dokumentów",
      emptyDescription:
        "Dodaj pierwszy plik tekstowy, aby przygotować uporządkowaną treść i nagranie.",
      emptyAction: "Dodaj pierwszy dokument",
      loadMore: "Załaduj więcej",
      loadingMore: "Ładowanie...",
      results: (visible: number, loaded: number) =>
        `Wyświetlono ${visible} z ${loaded} załadowanych dokumentów`,
      summary: {
        label: "Podsumowanie załadowanych dokumentów",
        loaded: "Załadowane dokumenty",
        processing: "W przetwarzaniu",
        ready: "Gotowe narracje",
        exports: "Dostępne pliki",
        scope:
          "Podsumowanie obejmuje obecnie załadowane dokumenty. Kolejne strony możesz pobrać poniżej tabeli.",
      },
      toolbar: {
        label: "Wyszukiwanie, filtrowanie i sortowanie dokumentów",
        searchLabel: "Szukaj dokumentów",
        statusLabel: "Filtruj według statusu",
        sortLabel: "Sortuj dokumenty",
      },
      filters: {
      ...
      sort: {
        ...
        titleAscending: "Tytuł: A–Z",
        titleDescending: "Tytuł: Z–A",
      },
      table: {
        caption: "Lista dokumentów i dostępnych działań",
        document: "Dokument",
        source: "Źródło i data",
        status: "Status",
        voiceModel: "Głos i model",
        size: "Rozmiar i długość",
        actions: "Działania",
      },
      row: {
        unavailable: "Brak danych",
        durationUnavailable: "Długość niedostępna",
      },
      actions: {
        label: (title: string) => `Działania dla dokumentu ${title}`,
        ...
        retrying: "Ponawianie...",
        retryUnavailable:
          "Ponowienie będzie dostępne po zakończeniu bieżącego przetwarzania.",
        delete: "Usuń",
        deleting: "Usuwanie",
        mp3Unavailable: "Nagranie MP3 nie jest jeszcze dostępne.",
        correctedUnavailable: "Poprawiony tekst nie jest jeszcze dostępny.",
        originalUnavailable: "Plik źródłowy nie jest dostępny.",
      ...
      dialog: {
        ...
        retry: {
          ...
          description: (title: string) =>
            `Dla dokumentu „${title}” powstanie nowe zadanie przetwarzania. Dotychczasowe pliki pozostaną dostępne do czasu zakończenia nowej próby.`,
          confirm: "Wygeneruj ponownie",
          error: "Nie udało się rozpocząć ponownego generowania.",
        },
        delete: {
          title: "Usunąć dokument?",
          description: (title: string) =>
            `Dokument „${title}” zostanie usunięty z biblioteki. Tej operacji nie można cofnąć w aplikacji.`,
          confirm: "Usuń dokument",
          error: "Nie udało się usunąć dokumentu.",
        },
      },
      filteredEmpty: {
        title: "Brak pasujących dokumentów",
        description: "Zmień wyszukiwanie lub wybrany filtr statusu.",
        reset: "Wyczyść filtry",
      },
      error: {
        title: "Nie udało się załadować dokumentów",
        description:
          "Obszar roboczy jest nadal dostępny. Spróbuj ponownie pobrać listę dokumentów.",
